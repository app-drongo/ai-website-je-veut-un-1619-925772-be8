...
import { ArrowRight, Crown, Users, Clock, Star } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "10K+", label: "Happy Customers", icon: Users },
    { value: "25min", label: "Avg Delivery", icon: Clock },
    { value: "500+", label: "Restaurant Partners", icon: Crown },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of food lovers who trust Queen Kitchen for fast, fresh, and delicious meals. 
                Order now and get 20% off your first delivery!
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Partnered with the city's best restaurants
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Restaurant logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div 
                      key={i} 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                On orders over $25, no hidden fees
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Fast & Fresh</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Only the finest restaurants and ingredients
              </p>
            </div>
          </div>
        </div>

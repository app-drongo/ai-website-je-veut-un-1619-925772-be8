...
// Generated: 2025-09-02T16:02:05.645Z
// Template: hero-s001
// Context: Homepage
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Experience the finest cuisine from Queen Kitchen's partner restaurants. Fresh, fast, and delivered with care to urban professionals who demand quality.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="text-base">
                <Clock className="mr-2 size-5" /> View Menu
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  src="https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?q=80&w=1920&auto=format&fit=crop"
                  alt="Delicious food delivery from Queen Kitchen"
                  fill
